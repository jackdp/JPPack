unit PNGC.PngFunctions;

{
  PngFunctions unit from https://bitbucket.org/uweraabe/pngcomponents downloaded on 27.04.2018

  JP mod:
  1. Changed unit name from PngFunctions to PNGC.PngFunctions.
  2. Added Classes unit to uses.
}

interface

uses
  Windows, Graphics, ImgList, Contnrs, pngimage, Classes;
