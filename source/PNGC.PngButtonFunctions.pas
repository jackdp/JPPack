unit PNGC.PngButtonFunctions;

{
  PngButtonFunctions unit from https://bitbucket.org/uweraabe/pngcomponents downloaded on 27.04.2018

  JP mod:
  1. Changed unit name from PngButtonFunctions to PNGC.PngButtonFunctions.
  2. Added Types unit to uses.
}

interface

uses
  Windows, Buttons, Graphics, pngimage, Types;
